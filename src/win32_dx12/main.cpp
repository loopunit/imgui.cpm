...
bool init_gui_win32_dx12()
{
	...
	globals::hwnd =
		::CreateWindow(globals::wc.lpszClassName, _T("Dear ImGui DirectX12 Example"), WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, NULL, NULL, globals::wc.hInstance, NULL);
...
static bool CreateDeviceD3D(HWND hWnd)
{
...

	{
		...
		if (CreateDXGIFactory1(IID_PPV_ARGS(&dxgiFactory)) != S_OK || dxgiFactory->CreateSwapChainForHwnd(g_pd3dCommandQueue, hWnd, &sd, NULL, NULL, &swapChain1) != S_OK ||
